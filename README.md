...

{
  ...
  "editor.formatOnSave": true,                              // Formata código automaticamente ao salvar
  "editor.codeActionsOnSave": {
    "source.fixAll.eslint": true,                           // Corrige problemas do ESLint ao salvar
    "source.organizeImports": true                          // Organiza imports automaticamente
  },
  ...
  // CodiumAI
  "codiumai.autoCompleteTests": true,                       // Gera testes automaticamente ao salvar
  "codiumai.languageSupport": ["javascript", "typescript"], // Linguagens suportadas pelo CodiumAI
  "codiumai.generateInlineSuggestions": true,               // Sugestões inline baseadas no código
